namespace WG3000_COMM.Reports.Shift
{
    ...
    public partial class dfrmShiftDelete : frmBioAccess
    {
                    ...
                    try
                    {
                        ...
                        if (errno == 0)
                        {
                            ...
                            for (num2 = 0; num2 <= (numArray.Length - 1); num2++)
                            {
                                ...
                                errno = shift.shift_arrange_delete(numArray[num2], dateStart, dateEnd);
                                if (errno != 0)
                                {
                                    XMessageBox.Show(this, shift.errDesc(errno), wgTools.MSGTITLE, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                    break;
                                }
                            }
                            if (errno == 0)
