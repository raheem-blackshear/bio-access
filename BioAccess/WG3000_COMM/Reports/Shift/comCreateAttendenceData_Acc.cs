namespace WG3000_COMM.Reports.Shift
{
    ...
    public class comCreateAttendenceData_Acc : Component
    {
        ...
        public comCreateAttendenceData_Acc(IContainer Container) : this()
        {
            Container.Add(this);
        }
        ...
        private void make4FourTimes()
        {
            ...
            OleDbDataReader reader = this.cmdConsumer.ExecuteReader();
            int num = 0;
            try
            {
                int num2 = 0;
                while (reader.Read())
                {
                    ...
                    this.daManualCardRecord = new OleDbDataAdapter(selectCommandText, this.cn);
                    ...
                    using (OleDbCommand command2 = new OleDbCommand((((selectCommandText + ", " + num12) + ", " + num13) + ", " + this.dvCardRecord.Count) + " )", this.cn))
                    {
                        if (this.cn.State == ConnectionState.Closed)
                        {
                            this.cn.Open();
        ...
        private void make4OneTime()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    using (OleDbCommand command2 = new OleDbCommand((((selectCommandText + ", " + num11) + ", " + num12) + ", " + this.dvCardRecord.Count) + " )", this.cn))
                    {
                        if (this.cn.State == ConnectionState.Closed)
                        {
                            this.cn.Open();
