...
*/
        ...
        private Color m_NormalToggledBkColor = Color.FromArgb(19, 88, 123);
...
*/
        ...
        */
        ...
        [Category("Appearance")]
        [Description("Button toggled.")]
        public bool Toggled
        {
            get { return toggled; }
            set { this.toggled = value; refresh_background(); }
        }

        private Color get_bk_color()
        {
            if (toggled)
                return m_NormalToggledBkColor;
            else
        ...
        {
            if (Enabled)
                BackColor = get_bk_color();
            else
                BackColor = m_DisabledBkColor;
