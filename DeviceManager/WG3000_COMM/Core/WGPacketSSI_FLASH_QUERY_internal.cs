namespace WG3000_COMM.Core
{
    ...
    internal class WGPacketSSI_FLASH_QUERY_internal : WGPacket
    {
        ...
        public WGPacketSSI_FLASH_QUERY_internal(byte typePar, byte codePar, uint snToPar, uint iStartFlashAddrPar, uint iEndFlashAddrPar) : base(typePar, codePar, snToPar)
        {
